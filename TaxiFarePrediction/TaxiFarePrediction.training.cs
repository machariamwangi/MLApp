    ...
    public partial class TaxiFarePrediction
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(new []{new InputOutputColumnPair(@"vendor_id", @"vendor_id"),new InputOutputColumnPair(@"payment_type", @"payment_type")})      
                                    ...
                                    .Append(mlContext.Regression.Trainers.FastTreeTweedie(new FastTreeTweedieTrainer.Options(){NumberOfLeaves=2570,MinimumExampleCountPerLeaf=85,NumberOfTrees=11972,MaximumBinCountPerFeature=186,LearningRate=0.013288666087714F,FeatureFraction=0.943934737414263F,LabelColumnName=@"fare_amount",FeatureColumnName=@"Features"}));
